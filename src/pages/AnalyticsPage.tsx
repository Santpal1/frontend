...
const AnalyticsPage: React.FC = () => {
    ...
    const fetchDepartments = useCallback(async () => {
        try {
            ...
            const res  = await fetch('https://srm-sp-production-dc63.up.railway.app/api/faculty', { headers });
    ...
    const generateReport = async () => {
        ...
        try {
            ...
            const facultyRes  = await fetch(`https://srm-sp-production-dc63.up.railway.app/api/faculty?${params}`, { headers });
                ...
                facultyList.map(async (f) => {
                    ...
                    try {
                        ...
                        const cRes = await fetch(
                            `https://srm-sp-production-dc63.up.railway.app/api/faculty/${fid}/country-stats?${csParams}`,
                            { headers }
                        );
