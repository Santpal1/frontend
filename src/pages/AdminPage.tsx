...
const AdminPage: React.FC = () => {
  ...
  const handleRunRefresh = () => {
    ...
    const eventSource = new EventSource("https://srm-sp-production-dc63.up.railway.app/admin/run-refresh-stream");
  ...
  const handleRunScopusScraper = () => {
    ...
    const eventSource = new EventSource("https://srm-sp-production-dc63.up.railway.app/admin/run-scopus-scraper");
  ...
  const handleRunQuartileUpload = () => {
    ...
    xhr.open("POST", "https://srm-sp-production-dc63.up.railway.app/admin/run-quartile-upload", true);
  ...
  const handleRunScivalUpload = () => {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open("POST", "https://srm-sp-production-dc63.up.railway.app/admin/run-scival-upload", true);
    xhr.setRequestHeader("Accept", "text/event-stream");
  ...
  const handleAddAuthor = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://srm-sp-production-dc63.up.railway.app/admin/add-author", {
        method: "POST",
        headers: {
  ...
  const fetchPendingFaculties = async () => {
    ...
    try {
      const response = await fetch("https://srm-sp-production-dc63.up.railway.app/admin/pending-authors");
      const result = await response.json();
      if (result.success) {
  ...
  const handleApprovePendingFaculty = async (authorId: number, authorName: string) => {
    ...
    try {
      const response = await fetch(`https://srm-sp-production-dc63.up.railway.app/admin/approve-author/${authorId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleRejectPendingFaculty = async () => {
    ...
    try {
      const response = await fetch(`https://srm-sp-production-dc63.up.railway.app/admin/reject-author/${rejectionAuthorData.id}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
