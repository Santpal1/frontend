...
export default function QuartileReportPage() {
    ...
    const fetchDepartments = async () => {
        try {
            const res = await axios.get("https://srm-sp-production-dc63.up.railway.app/api/faculty", { headers: getAuthHeaders() });
    ...
    const fetchQuartileReport = async () => {
        ...
        try {
            let url = `https://srm-sp-production-dc63.up.railway.app/api/faculty/quartile-report/data?year=${year}&quartile=${quartile}`;
    ...
    const fetchSummaryStats = async () => {
        try {
            let url = "https://srm-sp-production-dc63.up.railway.app/api/faculty/quartile-report/summary-stats";
            if (isAdmin && isAdmin() && departmentFilter && departmentFilter !== "all")
                url += `?department=${encodeURIComponent(departmentFilter)}`;
            const res = await axios.get(url, { headers: getAuthHeaders() });
