...
<div class="report-footer">
    ...
    const buildUrl = (year: number, dept: string) => {
        ...
        let url = `https://srm-sp-production-dc63.up.railway.app/api/paper-faculty-ratio?year=${year}`;
    ...
    const fetchDepartments = async () => {
        try {
            ...
            const res = await axios.get("https://srm-sp-production-dc63.up.railway.app/api/paper-faculty-ratio/departments", { headers });
    ...
    const fetchDeptStats = async (deptList: string[], year: number) => {
        ...
        for (const dept of deptList) {
            try {
                const url = `https://srm-sp-production-dc63.up.railway.app/api/paper-faculty-ratio?year=${year}&department=${encodeURIComponent(dept)}`;
